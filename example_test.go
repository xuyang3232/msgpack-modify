...
func ExampleMarshal() {
	...
	ii := new(Item)
	ii.Foo = "是一个缓冲byte类型的缓冲器存放着都是byte Buffer？"
	ii.Id = 123456789123456
	ii.Array1 = []int32{123,65534}
	ii.Array2 = []*OneItem{&OneItem{2100000000,666666}, &OneItem{777777,8888888}}
	b, err := msgpack.Marshal(ii)
	if err != nil {
		panic(err)
	}
